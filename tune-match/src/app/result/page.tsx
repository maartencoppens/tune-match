...
export default function ResultPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[linear-gradient(135deg,_#140421_0%,_#250a36_40%,_#16213e_100%)] p-6">
      ...
      <div className="flex flex-col items-center gap-4 relative w-full max-w-md rounded-3xl border border-white/10 bg-white/6 p-8 text-center shadow-[0_18px_50px_rgba(0,0,0,0.18)] backdrop-blur-sm">
        <Image
          ...
          height={480}
          priority
          className="mx-auto mb-6 h-auto w-auto object-contain"
        />{" "}
